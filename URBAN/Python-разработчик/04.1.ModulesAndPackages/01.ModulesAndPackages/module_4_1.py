...
# Бесконечность можно импорв него функции divide из модулей fake_math и true_math,
# назвав их разными именами на своё усмотрение, чтобы не было конфликтов имён,
# при помощи оператора as.
# Запустите эти функции в модуле module_4_1, передав первым тировать из встроенной
# библиотеки math (from math import inf)
# Пункты задачи:
# Создайте модули fake_math и true_math.
# Напишите функции divide в обоих методах. Разница между этими
# функциями - возвращаемое значение.
# Создайте модуль module_4_1 (если ещё не создан), импортируйте аргументом
