...
test_function()  # выведет "Я в области видимости функции test_function"
# inner_function - выдает ошибку так как эта функция находится в пространстве имен функции test_function
