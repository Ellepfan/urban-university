...
# __ne__(!=) должны присутствовать в классе и возвращать результаты сравнения
# по соответствующим операторам. Как и в методе __eq__ в сравнении
...
# __radd__(self, value), __iadd__(self, value) - работают так же как и
# __add__ (возвращают результат его вызова).
